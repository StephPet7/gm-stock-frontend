...
declare namespace meow {
	interface Options<Flags extends MinimistOptions> {
		...
		*/
		...
		/**
		Description to show above the help text. Default: The proxy.conf.json `"description"` property.
		...
		*/
		...
		/**
		Set a custom version output. Default: The proxy.conf.json `"version"` property.
		...
		*/
		...
		/**
		proxy.conf.json as an `Object`. Default: Closest proxy.conf.json upwards.
