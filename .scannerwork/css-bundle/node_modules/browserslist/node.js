...
module.exports = {
  ...
  loadConfig: function loadConfig (opts) {
    if (process.env.BROWSERSLIST) {
      ...
      if (path.basename(file) === 'proxy.conf.json') {
  ...
  findConfig: function findConfig (from) {
    ...
    var resolved = eachParent(from, function (dir) {
      ...
      var pkg = path.join(dir, 'proxy.conf.json')
      ...
      if (isFile(config) && pkgBrowserslist) {
        throw new BrowserslistError(
          dir + ' contains both browserslist and proxy.conf.json with browsers'
        )
      } else if (isFile(rc) && pkgBrowserslist) {
        throw new BrowserslistError(
          dir + ' contains both .browserslistrc and proxy.conf.json with browsers'
        )
  ...
  oldDataWarning: function oldDataWarning (agentsObj) {
    ...
    if (latest !== 0 && latest < halfYearAgo) {
      ...
      eachParent(__filename, function (dir) {
        var pckg = path.join(dir, 'proxy.conf.json')
